...
def single_gpu_test_analysis(model, data_loader, show=False, out_dir=None, show_score_thr=0.3, analysis_scale=1.0):
    model.eval()
    results = []
    ...
    for i, data in enumerate(data_loader):
        ...
        with torch.no_grad():
            ...
            result = model(return_loss=True, rescale=True, **data, batch_idx=i, analysis_scale=analysis_scale)
