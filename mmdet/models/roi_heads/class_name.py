...
COCO_UNSEEN_CLS = [
    'airplane', 'bus', 'cat', 'dog', 'cow', 'elephant', 'umbrella',
...
coco_base_label_ids = [COCO_OVD_ALL_CLS.index(i) for i in COCO_SEEN_CLS]
coco_novel_label_ids = [COCO_OVD_ALL_CLS.index(i) for i in COCO_UNSEEN_CLS]
# fmt: on
