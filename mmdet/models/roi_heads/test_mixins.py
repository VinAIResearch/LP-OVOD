...
class BBoxTestMixin(object):
    if sys.version_info >= (3, 7):
        ...
        async def async_test_bboxes(
            self, x, img_metas, proposals, rcnn_test_cfg, rescale=False, bbox_semaphore=None, global_lock=None
        ):
    ...
    def aug_test_bboxes(self, feats, img_metas, proposal_list, rcnn_test_cfg):
        ...
        det_bboxes, det_labels = multiclass_nms(
            merged_bboxes, merged_scores, rcnn_test_cfg.score_thr, rcnn_test_cfg.nms, rcnn_test_cfg.max_per_img
        )
        return det_bboxes, det_labels
...
class MaskTestMixin(object):
    ...
    def aug_test_mask(self, feats, img_metas, det_bboxes, det_labels):
        ...
        if det_bboxes.shape[0] == 0:
            ...
            segm_result = self.mask_head.get_seg_masks(
                merged_masks, det_bboxes, det_labels, self.test_cfg, ori_shape, scale_factor=1.0, rescale=False
            )
        return segm_result
