...
def parse_args():
    ...
    parser.add_argument("--outfile", default=None, type=str, help="Output file")
...
def main():
    ...
    #     id_idx[int(data['img_metas'][0].data['ori_filename'][:12])] = i

    # print("Saving id map...")
    # mmcv.dump(id_idx, "train_id_map.json")
    if not distributed:
