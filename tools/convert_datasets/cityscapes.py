...
def load_img_info(files):
    ...
    for inst_id in unique_inst_ids:
        ...
        anno = dict(
            iscrowd=iscrowd, category_id=category_id, bbox=bbox.tolist(), area=area.tolist(), segmentation=mask_rle
        )
...
def main():
    ...
    for split, json_name in set_name.items():
        ...
        with mmcv.Timer(print_tmpl="It tooks {}s to convert Cityscapes annotation"):
